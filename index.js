...
const accomplishmentArray = [
  ...
  },
  {
    id: 2,
    title: 'Meal-app',
    skill: ['Javascript', 'external api', 'testing'],
    description:
    ...
    technologies: ['html', 'css', 'javascript', 'github', 'jest', 'Bootstraps'],
    ImageForMobile: './images/third-work.svg',
    ImageForDesktop: './images/meal-app.PNG',
    accomplishmentDetailModel: './images/meal-app.PNG',
    alt: 'Meal-app to display menu',
